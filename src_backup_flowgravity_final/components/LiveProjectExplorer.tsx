      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 font-mono text-sm tracking-widest uppercase">
            Despliegues reales activos • Click para explorar
          </p>
        </motion.div>
        ...
        <div className="space-y-32">
          {projects.map((project, index) => (
            ...
            >
              {/* Enlace que cubre TODO el componente */}
              <a 
                href={project.url}
                target="_blank"
              ...
              <div className="flex flex-col md:flex-row justify-between items-end mb-6 px-2 gap-4 select-none">
                <div>
              ...
              <div className={`relative rounded-3xl overflow-hidden border border-white/10 bg-[#0a0a0a] shadow-2xl transition-all duration-500 group-hover:border-opacity-50 ${project.shadowColor} group-hover:${project.borderColor}`}>
                ...
                {/* IFRAME AREA: SIMPLE Y LIMPIA
                    - overflow-hidden: Corta lo que sobra
                    - pointer-events-none: Interacción desactivada (la toma el link z-50)
                */}
                <div className="relative w-full h-[500px] md:h-[700px] bg-neutral-900 pointer-events-none"> 
